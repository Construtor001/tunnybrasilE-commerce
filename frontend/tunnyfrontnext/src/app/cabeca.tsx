            ...
            <div className={style.centro}>
                ...
                <div className={style.barramenu}>
                    <div className={style.juncao} >
                        <Image  width={30} height={25} src="/Image/barraCatalogo.png" alt="logo" className={style.barraimg}/>
                        <p className={style.nomeBarraCatalogo}></p>
                    </div>
                    ...
                    <div onClick={bloquearClick} className={style.englob}>
                        ...
                        <Image src="/Image/lupa.png" alt="logo" width={15} height={20} className={style.imagemPesquisar_1}/>
                ...
                <div className={style.barraconteudo}>
                    ...
                    <Link style={{textDecoration:"none"}} href={"/cupons"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Roupas</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/suporte"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Bolsas</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/meusPedidos"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Acessorios</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/customizar"}>
                            <p className={style.conteudos}>
                                <p className={style.padrao_nomes_departamentos}> Mochilas</p>
                            </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/sugestoes"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Tenis</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/conversa"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Toalhas</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/favoritos"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Lençol de cama</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/cesta"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Bonecos</p>
                        </p>
                    </Link>
                    <Link style={{textDecoration:"none"}} href={"/#"}>
                        <p className={style.conteudos}>
                            <p className={style.padrao_nomes_departamentos}>Personalizados</p>
                        </p>
                    </Link>
